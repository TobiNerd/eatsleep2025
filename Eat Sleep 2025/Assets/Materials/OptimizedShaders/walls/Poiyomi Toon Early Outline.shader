Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Outline Early/3185ee955781e8643ba2302bcadbe87e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.03125,0.015625,32,64), mainUV);
				}
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.8960326,0.6821064,0.2387567,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.8960326,0.6821064,0.2387567,1).a;

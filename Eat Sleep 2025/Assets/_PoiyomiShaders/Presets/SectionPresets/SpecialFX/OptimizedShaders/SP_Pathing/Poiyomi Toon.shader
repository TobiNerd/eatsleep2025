Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c4e75bdfe85bdfb42a5bc0a488037569"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				PathColor[3] = float4(1,1,1,1);
				if ((0.0 /*_PathGradientType*/) == 1)
				{
					path = (path.r + path.g + path.b + path.a) * .25;
				}
				#if defined(PROP_PATHINGCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				float4 pathColorMap = POI2D_SAMPLER_PAN(_PathingColorMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_PathingColorMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				...
				for (int index = 0; index < 4; index++)
				{
					...
					#endif
					pathTime[index] = float4(-999,-999,-999,-999)[index] != -999.0f ? frac(float4(-999,-999,-999,-999)[index] + float4(0,0,0,0)[index] + timeOffset) : frac(_Time.x * float4(1,1.1,1.2,1.3)[index] + float4(0,0,0,0)[index] + timeOffset);
					...
					if (path[index])
					{
						half pathWidth = float4(0.03,0.03,0.03,0.03)[index] * .5;
						#ifdef POI_AUDIOLINK
				...
				pathEmission = 0;
				pathEmission += pathAlpha[0][(1.0 /*_PathTypeR*/)] * poiThemeColor(poiMods, PathColor[0].rgb, (0.0 /*_PathColorRThemeIndex*/)) * (float4(4,4,4,4)[0] + pathAudioLinkEmission.r);
				pathEmission += pathAlpha[1][(1.0 /*_PathTypeG*/)] * poiThemeColor(poiMods, PathColor[1].rgb, (0.0 /*_PathColorGThemeIndex*/)) * (float4(4,4,4,4)[1] + pathAudioLinkEmission.g);
				pathEmission += pathAlpha[2][(1.0 /*_PathTypeB*/)] * poiThemeColor(poiMods, PathColor[2].rgb, (0.0 /*_PathColorBThemeIndex*/)) * (float4(4,4,4,4)[2] + pathAudioLinkEmission.b);
				pathEmission += pathAlpha[3][(1.0 /*_PathTypeA*/)] * poiThemeColor(poiMods, PathColor[3].rgb, (0.0 /*_PathColorAThemeIndex*/)) * (float4(4,4,4,4)[3] + pathAudioLinkEmission.a);
				pathEmission *= pathColorMap.rgb * pathColorMap.a;
				float3 colorReplace = 0;
				colorReplace = pathAlpha[0][(1.0 /*_PathTypeR*/)] * poiThemeColor(poiMods, PathColor[0].rgb, (0.0 /*_PathColorRThemeIndex*/)) * pathColorMap.rgb;
				albedo.rgb = lerp(albedo.rgb, colorReplace + albedo.rgb * 0.00001, pathColorMap.a * PathColor[0].a * pathAlpha[0][(1.0 /*_PathTypeR*/)]);
				colorReplace = pathAlpha[1][(1.0 /*_PathTypeG*/)] * poiThemeColor(poiMods, PathColor[1].rgb, (0.0 /*_PathColorGThemeIndex*/)) * pathColorMap.rgb;
				albedo.rgb = lerp(albedo.rgb, colorReplace + albedo.rgb * 0.00001, pathColorMap.a * PathColor[1].a * pathAlpha[1][(1.0 /*_PathTypeG*/)]);
				colorReplace = pathAlpha[2][(1.0 /*_PathTypeB*/)] * poiThemeColor(poiMods, PathColor[2].rgb, (0.0 /*_PathColorBThemeIndex*/)) * pathColorMap.rgb;
				albedo.rgb = lerp(albedo.rgb, colorReplace + albedo.rgb * 0.00001, pathColorMap.a * PathColor[2].a * pathAlpha[2][(1.0 /*_PathTypeB*/)]);
				colorReplace = pathAlpha[3][(1.0 /*_PathTypeA*/)] * poiThemeColor(poiMods, PathColor[3].rgb, (0.0 /*_PathColorAThemeIndex*/)) * pathColorMap.rgb;
				albedo.rgb = lerp(albedo.rgb, colorReplace + albedo.rgb * 0.00001, pathColorMap.a * PathColor[3].a * pathAlpha[3][(1.0 /*_PathTypeA*/)]);
				float alpha = max(max(max(pathAlpha[0][(1.0 /*_PathTypeR*/)], pathAlpha[1][(1.0 /*_PathTypeG*/)]), pathAlpha[2][(1.0 /*_PathTypeB*/)]), pathAlpha[3][(1.0 /*_PathTypeA*/)]);

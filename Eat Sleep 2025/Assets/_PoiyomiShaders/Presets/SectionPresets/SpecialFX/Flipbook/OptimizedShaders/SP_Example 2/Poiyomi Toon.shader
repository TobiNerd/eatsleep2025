Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/05876963e63ea1d4ca48f7331a07be97"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					if ((8.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = ((_Time.y / (1 / (8.0 /*_FlipbookFPS*/))) + (0.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, flipBookPixel.rgb, (2.0 /*_FlipbookBlendType*/)), flipBookPixel.a * float4(1,1,1,1).a * (1.0 /*_FlipbookReplace*/) * flipBookMask * flipbookAlpha);

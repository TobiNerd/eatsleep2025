Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d12af220903388446bd961e8c9ea281b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if ((1.0 /*_VisibilityMode*/) == 1) // VRC
				{
					...
					notVisible += (!(0.0 /*_VisibilityVRCRegular*/) && ((mirrorMode == 0) && (cameraMode == 0)));
					notVisible += (!(1.0 /*_VisibilityVRCMirrorVR*/) && (mirrorMode == 1));
					notVisible += (!(1.0 /*_VisibilityVRCMirrorDesktop*/) && (mirrorMode == 2));
					notVisible += (!(1.0 /*_VisibilityVRCCameraVR*/) && (cameraMode == 1));
					notVisible += (!(1.0 /*_VisibilityVRCCameraDesktop*/) && (cameraMode == 2));
			...
			void applyMirror(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, mirrorTexture.rgb, (0.0 /*_MirrorTextureBlendType*/)), mirrorTexture.a * float4(1,1,1,1).a);
					poiFragData.baseColor.rgb *= lerp(1, poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_MirrorColorThemeIndex*/)), float4(1,1,1,1).a);
				}
				#else
				if (inMirror && (0.0 /*_MirrorTextureEnabled*/) || (0.0 /*_MirrorTextureForceEnabled*/))
				{

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/875f091e17ef9e543b0d724d35217dff"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if ((1.0 /*_VisibilityMode*/) == 1) // VRC
				{
					...
					notVisible += (!(1.0 /*_VisibilityVRCCameraScreenshot*/) && (cameraMode == 3));
				}
			...
			void applyMirror(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, mirrorTexture.rgb, (8.0 /*_MirrorTextureBlendType*/)), mirrorTexture.a * float4(1,1,1,1).a);

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/43b9b34b6d13c6e42b797482b23be0af"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0.4679586,1,0,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0.4679586,1,0,1).a);
					#ifndef POI_SHADOW

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ac91eb1f4fca8694da6dab0fec5a1bf7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.05 /*_DissolveDetailStrength*/);
				...
				if ((1.0 /*_DissolveHueShiftEnabled*/))
				{
				...
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(1,0,0,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(1,0,0,1).a);
					#ifndef POI_SHADOW
					
					if ((1.0 /*_DissolveEdgeHueShiftEnabled*/))
					{
						edgeColor.rgb = hueShift(edgeColor.rgb, (0.0 /*_DissolveEdgeHueShift*/) + _Time.x * (50.0 /*_DissolveEdgeHueShiftSpeed*/), (0.0 /*_DissolveEdgeHueShiftColorSpace*/), (1.0 /*_DissolveEdgeHueSelectOrShift*/));
					}
					#endif
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (20.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif

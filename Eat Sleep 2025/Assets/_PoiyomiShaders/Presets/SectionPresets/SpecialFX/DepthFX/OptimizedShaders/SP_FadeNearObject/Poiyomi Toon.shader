Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/85ae851a357ebf4429ba502c9c0a1a64"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDepthFX(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_DepthColorToggle*/))
				{
					float colorBlendAlpha = lerp((0.0 /*_DepthColorMinValue*/), (1.0 /*_DepthColorMaxValue*/), remapClamped((0.0 /*_DepthColorMinDepth*/), (1.0 /*_DepthColorMaxDepth*/), diff));
					#if defined(PROP_DEPTHTEXTURE) || !defined(OPTIMIZER_ENABLED)
					float2 depthTextureUV = float2(0, 0);
					if ((0.0 /*_DepthTextureUV*/) == 8)
					{
						depthTextureUV = lerp(0, 1, remapClamped((0.0 /*_DepthColorMinDepth*/), (1.0 /*_DepthColorMaxDepth*/), diff));
					}
					else
					{
						depthTextureUV = poiMesh.uv[(0.0 /*_DepthTextureUV*/)];
					}
					float3 depthColor = POI2D_SAMPLER_PAN(_DepthTexture, _MainTex, poiUV(depthTextureUV, float4(1,1,0,0)), float4(0,0,0,0)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DepthColorThemeIndex*/));
					#else
					float3 depthColor = poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DepthColorThemeIndex*/));
					#endif

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e5a42ecf096cbd141b1ea46dd190391c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (700.0 /*_GlitterFrequency*/);
					...
					#endif
					switch((2.0 /*_GlitterMode*/))
					{
						case 0:
						
						if ((0.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (30.0 /*_GlitterAngleRange*/), (0.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.8 /*_GlitterBias*/)), poiCam.viewDir)), (200.0 /*_GlitterContrast*/)), 0);
						finalGlitter *= glitterAlpha;
						break;
						case 1:
						float randomOffset = random(randoPoint);
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (0.0 /*_GlitterSpeed*/)) * .5 + .5);
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (200.0 /*_GlitterContrast*/)), 0);
					...
					glitterMask *= lerp(1, poiLight.rampedLightMap, (0.9 /*_GlitterHideInShadow*/));
					glitterMask *= lerp(1, poiLight.directLuminance, (0.76 /*_GlitterScaleWithLighting*/));

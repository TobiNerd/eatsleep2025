Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/fffc9a264f0cea34e98d4ce8bcac38cd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 lilCalcSpecular(PoiMesh poiMesh, PoiCam poiCam, float3 L, float3 specular, float attenuation, float roughness)
			{
				...
				return poiEdgeLinear(pow(nh, 1.0 / roughness), (0.5 /*_SpecularBorder*/), (0.1 /*_SpecularBlur*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.04491682,0.153095,0.01335564,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.04491682,0.153095,0.01335564,1).a;

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/520c0c3795796fb439a68661b0844ffc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void CalculateUTSSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.4 /*_HighColor_Power*/)))) * (0.4 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.1 /*_Layer2Size*/)))) * (0.2 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.4 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (0.4 /*_Layer1Strength*/);
					specMask2 += poiEdgeNonLinear(specArea, (1.0 - pow((0.1 /*_Layer2Size*/), 5)), (0.15 /*_StylizedSpecular2Feather*/)) * (0.2 /*_Layer2Strength*/);
				}
				#if defined(PROP_SET_HIGHCOLORMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.4 /*_HighColor_Power*/)))) * (0.4 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.1 /*_Layer2Size*/)))) * (0.2 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.4 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (0.4 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, poiEdgeNonLinear(specArea, (1.0 - pow((0.1 /*_Layer2Size*/), 5)), (0.15 /*_StylizedSpecular2Feather*/)) * (0.2 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.02285505,0.02285505,0.02285505,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.02285505,0.02285505,0.02285505,1).a;

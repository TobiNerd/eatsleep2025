Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/11ce4bd1b7b381f4abef3a8d553a0cc8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.0 /*_RimEnviroSharpness*/), (0.45 /*_RimEnviroWidth*/)), (0.45 /*_RimEnviroWidth*/), poiCam.vDotN));
				...
				#endif
				float3 envRimCol = lerp(0, max(0, (enviroRimColor - (0.0 /*_RimEnviroMinBrightness*/)) * poiFragData.baseColor), enviroRimAlpha).rgb * enviroMask * (1.0 /*_RimEnviroIntensity*/);

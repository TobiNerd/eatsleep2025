Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d81ca65a9d60213408b2809b50d034ca"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, (0.0 /*_CubeMapLightMask*/)));
				float cubeMapAlpha = CubeMapMask * cubeMap.a * (1.0 /*_CubeMapBlendAmount*/);
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, cubeMapAlpha * ((0.0 /*_CubemapBlendType*/) == 0));
				poiFragData.baseColor.rgb *= lerp(1, cubeMap.rgb, cubeMapAlpha * ((0.0 /*_CubemapBlendType*/) == 1));
				poiFragData.baseColor.rgb += cubeMap.rgb * cubeMapAlpha * ((0.0 /*_CubemapBlendType*/) == 2);

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/96fd1f4c49b942647b8851a0e9d7970c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_CubeMapUVMode*/))
				{
					...
					CubeMapUV = lerp(poiMesh.normals[0], poiMesh.normals[1], (1.0 /*_CubeMapWorldNormalsStrength*/));
					break;
				...
				float4 cubeMap = texCUBElod(_CubeMap, float4(CubeMapUV, (1 - (1.0 /*_CubeMapSmoothness*/)) * (1 - (1.0 /*_CubeMapSmoothness*/)) * 8));
				cubeMap.rgb *= poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
				cubeMap.rgb *= (1.0 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				float CubeMapMask = POI2D_SAMPLER_PAN(_CubeMapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_CubeMapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_CubeMapMaskChannel*/)];
				#else
				float CubeMapMask = 1;
				#endif
				if ((0.0 /*_CubeMapMaskGlobalMask*/) > 0)
				{
					CubeMapMask = maskBlend(CubeMapMask, poiMods.globalMask[(0.0 /*_CubeMapMaskGlobalMask*/) - 1], (2.0 /*_CubeMapMaskGlobalMaskBlendType*/));
				}
				if ((0.0 /*_CubeMapMaskInvert*/))
				{
					CubeMapMask = 1 - CubeMapMask;
				}
				if ((0.0 /*_CubeMapHueShiftEnabled*/))
				{
					cubeMap.rgb = hueShift(cubeMap.rgb, (0.0 /*_CubeMapHueShift*/) + _Time.x * (0.0 /*_CubeMapHueShiftSpeed*/), (0.0 /*_CubeMapHueShiftColorSpace*/), (1.0 /*_CubeMapHueSelectOrShift*/));
					cubeMap = PoiColorBCS(cubeMap, (0.0 /*_CubeMapBrightness*/), (1.0 /*_CubeMapContrast*/), (1.0 /*_CubeMapSaturation*/));
				}
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, (0.9 /*_CubeMapLightMask*/)));
				float cubeMapAlpha = CubeMapMask * cubeMap.a * (1.0 /*_CubeMapBlendAmount*/);
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, cubeMapAlpha * ((2.0 /*_CubemapBlendType*/) == 0));
				poiFragData.baseColor.rgb *= lerp(1, cubeMap.rgb, cubeMapAlpha * ((2.0 /*_CubemapBlendType*/) == 1));
				poiFragData.baseColor.rgb += cubeMap.rgb * cubeMapAlpha * ((2.0 /*_CubemapBlendType*/) == 2);
				poiFragData.emission += cubeMap.rgb * (0.0 /*_CubeMapEmissionStrength*/) * CubeMapMask * cubeMap.a;
			}
			#endif

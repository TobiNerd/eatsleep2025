Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/75d263e6e3f35724ca3382292f9883b6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				...
				float3 ssaoColor = poiThemeColor(poiMods, float4(0.2086369,0.05126945,0.08650045,1).rgb, (0.0 /*_SSAOColorThemeIndex*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSAOUseSurfaceColor*/));
				if (any(float4(0,0,0,1)))
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, lilToneCorrection(poiFragData.baseColor, float4(0,0,0,1) + 1), (1 - ssao) * (1.272 /*_SSAOIntensity*/));
				}
				poiFragData.baseColor = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, ssaoColor, (2.0 /*_SSAOBlendType*/)), (1 - ssao) * (1.272 /*_SSAOIntensity*/));
			}
			#endif

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/2343add4b71cbbe468e9eaf1f3e0a880"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				...
				if (any(float4(0,0,-0.1,2)))
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, lilToneCorrection(poiFragData.baseColor, float4(0,0,-0.1,2) + 1), (1 - ssao) * (1.5 /*_SSAOIntensity*/));
				}
				poiFragData.baseColor = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, ssaoColor, (2.0 /*_SSAOBlendType*/)), (1 - ssao) * (1.5 /*_SSAOIntensity*/));
			}
			#endif

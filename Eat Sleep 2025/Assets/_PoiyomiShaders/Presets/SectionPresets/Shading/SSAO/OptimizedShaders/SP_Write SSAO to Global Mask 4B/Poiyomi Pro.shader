Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/66f7fcad117c7004c996e76130140098"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float calculateSSAO(PoiMesh poiMesh, PoiCam poiCam, inout PoiLight poiLight, inout PoiMods poiMods)
			{
				...
				if ((15.0 /*_SSAOApplyGlobalMaskIndex*/) > 0)
				{
					applyToGlobalMask(poiMods, (15.0 /*_SSAOApplyGlobalMaskIndex*/) - 1, (1.0 /*_SSAOApplyGlobalMaskBlendType*/), ssao);
				}
				return ssao;
			}

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/b1e0ee328f6e5b74abe8d83c08bfe97c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.occlusion = min(min(min(lerp(1, AOMaps.r, (0.0 /*_LightDataAOStrengthR*/)), lerp(1, AOMaps.g, (0.0 /*_LightDataAOStrengthG*/))), lerp(1, AOMaps.b, (0.0 /*_LightDataAOStrengthB*/))), lerp(1, AOMaps.a, (0.55 /*_LightDataAOStrengthA*/)));
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1746474,0.1679254,0.1600616,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1746474,0.1679254,0.1600616,1).a;

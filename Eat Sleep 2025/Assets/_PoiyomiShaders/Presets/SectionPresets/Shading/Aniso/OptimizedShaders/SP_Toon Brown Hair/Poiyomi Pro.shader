Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/db57871b86cca8141b226b49fc8abb86"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAnisotropics(inout PoiFragData poiFragData, inout PoiLight poiLight, in PoiCam poiCam, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				spec0 = lerp(spec0, aaEdgeFeather(spec0, (0.408 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (1.0 /*_Aniso0ToonMode*/));
				spec1 = lerp(spec1, aaEdgeFeather(spec1, (0.005 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (1.0 /*_Aniso1ToonMode*/));
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						vSpec0 = lerp(vSpec0, aaEdgeFeather(vSpec0, (0.408 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (1.0 /*_Aniso0ToonMode*/));
						vSpec1 = lerp(vSpec1, aaEdgeFeather(vSpec1, (0.005 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (1.0 /*_Aniso1ToonMode*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1399849,0.08342824,0.04612799,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1399849,0.08342824,0.04612799,1).a;

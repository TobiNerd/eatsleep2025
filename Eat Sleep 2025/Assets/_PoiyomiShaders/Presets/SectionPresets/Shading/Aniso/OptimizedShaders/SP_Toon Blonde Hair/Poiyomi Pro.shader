Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/319189ffa0363c748ba138ec84c29280"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_LightingMulitlayerNonLinear*/))
				{
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(1,0,0,1).rgb * float4(1,0,0,1).a);
			...
			{
				#if defined(PROP_ANISOCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				float4 specMap = POI2D_SAMPLER_PAN(_AnisoColorMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_AnisoColorMapUV*/)], float4(5,5,0,0)), float4(0,0,0,0));
				#else
				float4 specMap = float4(1, 1, 1, 0);
				#endif
				float shadowMask = lerp(1, poiMax(poiLight.rampedLightMap), (0.9 /*_AnisoHideInShadow*/));
				#ifdef POI_PASS_ADD
				shadowMask *= poiLight.additiveShadow;
				#endif
				if ((0.0 /*_AnisoGlobalMask*/) > 0)
				{
					shadowMask = customBlend(shadowMask, poiMods.globalMask[(0.0 /*_AnisoGlobalMask*/) - 1], (2.0 /*_AnisoGlobalMaskBlendType*/));
				}
				float spec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso0SwitchDirection*/)), (-0.5 /*_Aniso0Offset*/) +(1.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.1 /*_Aniso0Power*/) * 1000, (1.0 /*_Aniso0Strength*/), shadowMask);
				float spec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (-0.05 /*_Aniso1Offset*/) +(0.1 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.25 /*_Aniso1Power*/) * 1000, (0.389 /*_Aniso1Strength*/), shadowMask);
				spec0 = lerp(spec0, aaEdgeFeather(spec0, (0.5 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (1.0 /*_Aniso0ToonMode*/));
				spec1 = lerp(spec1, aaEdgeFeather(spec1, (0.5 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (1.0 /*_Aniso1ToonMode*/));
				float3 spec0Color = specMap.rgb * poiThemeColor(poiMods, float4(0.6038274,0.6038274,0.6038274,1).rgb, (0.0 /*_Aniso0TintIndex*/));
				float3 spec1Color = specMap.rgb * poiThemeColor(poiMods, float4(0.1328683,0.1328683,0.1328683,1).rgb, (0.0 /*_Aniso1TintIndex*/));
				float3 finalSpec = saturate(saturate(spec0 * spec0Color) + saturate(spec1 * spec1Color)) * lerp(1, poiFragData.baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/));
				float3 baseColor = poiFragData.baseColor;
				poiFragData.baseColor = lerp(poiFragData.baseColor, spec1Color * lerp(1, baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * spec1);
				poiFragData.baseColor = lerp(poiFragData.baseColor, spec0Color * lerp(1, baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * spec0);
				poiLight.finalLightAdd += max(0, finalSpec * (0.5 /*_AnisoAdd*/));
				if (poiFragData.toggleVertexLights)
				{
					#if defined(VERTEXLIGHT_ON)
					for (int index = 0; index < 4; index++)
					{
						float vSpec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso0SwitchDirection*/)), (-0.5 /*_Aniso0Offset*/) +(1.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.1 /*_Aniso0Power*/) * 1000, (1.0 /*_Aniso0Strength*/), poiLight.vSaturatedDotNL[index]);
						float vSpec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (-0.05 /*_Aniso1Offset*/) +(0.1 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.25 /*_Aniso1Power*/) * 1000, (0.389 /*_Aniso1Strength*/), poiLight.vSaturatedDotNL[index]);
						vSpec0 = lerp(vSpec0, aaEdgeFeather(vSpec0, (0.5 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (1.0 /*_Aniso0ToonMode*/));
						vSpec1 = lerp(vSpec1, aaEdgeFeather(vSpec1, (0.5 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (1.0 /*_Aniso1ToonMode*/));
						float3 vSpec0Color = spec0Color;
						float3 vSpec1Color = spec1Color;
						poiLight.finalLightAdd += max(0, saturate(saturate(vSpec0 * vSpec0Color) + saturate(vSpec1 * vSpec1Color)) * lerp(1, poiFragData.baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)) * (0.5 /*_AnisoAdd*/));
						poiFragData.baseColor = lerp(poiFragData.baseColor, vSpec1Color * lerp(1, baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * vSpec1);
						poiFragData.baseColor = lerp(poiFragData.baseColor, vSpec0Color * lerp(1, baseColor, (0.5 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * vSpec0);
					}
					#endif
				}
			}
			...
			float calculateSSAO(PoiMesh poiMesh, PoiCam poiCam, inout PoiLight poiLight, inout PoiMods poiMods)
			{
				...
				mask = POI2D_SAMPLER_PAN(_SSAOMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_SSAOMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_SSAOMaskChannel*/)];
				mask = (0.0 /*_SSAOMaskInvert*/) > 0 ? 1 - mask : mask;
				#endif
				#endif
			...
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				...
				float2 uv = (0.0 /*_SSAOAsRamp*/) ? ssao : poiMesh.uv[(0.0 /*_SSAOColorMapUV*/)] ;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_LIGHTINGAOMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 AOMaps = POI2D_SAMPLER_PAN(_LightingAOMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_LightingAOMapsUV*/)], float4(5,5,0,0)), float4(0,0,0,0));
				poiLight.occlusion = min(min(min(lerp(1, AOMaps.r, (0.0 /*_LightDataAOStrengthR*/)), lerp(1, AOMaps.g, (0.0 /*_LightDataAOStrengthG*/))), lerp(1, AOMaps.b, (0.0 /*_LightDataAOStrengthB*/))), lerp(1, AOMaps.a, (0.319 /*_LightDataAOStrengthA*/)));
				#else
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb * poiLight.vAttenuation[index], (2.5 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb * poiLight.vAttenuation[index];
				...
				{
					poiLight.directColor = min(poiLight.directColor, (2.5 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (2.5 /*_LightingCap*/));
				}
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb * poiLight.attenuation, (2.5 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb * poiLight.attenuation;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.5 /*_LightingAdditivePassthrough*/));
				poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(poiLight.indirectColor, (2.5 /*_LightingAdditiveLimit*/)) : poiLight.indirectColor;
				#endif
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.8549927,0.4506329,0.08437622,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.8549927,0.4506329,0.08437622,1).a;

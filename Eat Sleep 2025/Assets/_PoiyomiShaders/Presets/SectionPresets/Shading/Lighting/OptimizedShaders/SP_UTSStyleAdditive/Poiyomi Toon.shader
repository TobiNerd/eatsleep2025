Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d6d1c75edfd0ec94ab3a549a6bdcef28"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					float2 ToonAddGradient = float2((1.0 /*_LightingAdditiveGradientStart*/), (1.0 /*_LightingAdditiveGradientEnd*/));

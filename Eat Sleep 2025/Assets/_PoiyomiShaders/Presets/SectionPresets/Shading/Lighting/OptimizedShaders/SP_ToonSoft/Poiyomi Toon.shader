Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4c3cdf4c10c2a2d4383c5c6329bf7d0e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					float2 ToonAddGradient = float2((0.35 /*_LightingAdditiveGradientStart*/), (0.38 /*_LightingAdditiveGradientEnd*/));

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c0880ad625af101439c2010fe559c70b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#ifdef POI_MATCAP0
				matcapALD.matcapALEnabled = (1.0 /*_Matcap0ALEnabled*/);
				matcapALD.matcapALAlphaAddBand = (0.0 /*_Matcap0ALAlphaAddBand*/);
				matcapALD.matcapALAlphaAdd = float4(0,0,0,0);
				matcapALD.matcapALEmissionAddBand = (2.0 /*_Matcap0ALEmissionAddBand*/);
				matcapALD.matcapALEmissionAdd = float4(0,0.2,0,0);
				...
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_MatcapUVMode*/), (1.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.5 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (1.0 /*_MatcapNormal*/), matcapALD);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.25 /*_MatcapMultiply*/), (0.25 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				matcapALD.matcapALEnabled = (1.0 /*_Matcap1ALEnabled*/);
				matcapALD.matcapALAlphaAddBand = (0.0 /*_Matcap1ALAlphaAddBand*/);
				matcapALD.matcapALAlphaAdd = float4(0,0,0,0);
				matcapALD.matcapALEmissionAddBand = (2.0 /*_Matcap1ALEmissionAddBand*/);
				matcapALD.matcapALEmissionAdd = float4(0,0.2,0,0);
				...
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.5 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					float mipCount2 = 9;
					if (float4(0.0078125,0.0078125,128,128).z == 8192) mipCount2 = 13;
					if (float4(0.0078125,0.0078125,128,128).z == 4096) mipCount2 = 12;
					if (float4(0.0078125,0.0078125,128,128).z == 2048) mipCount2 = 11;
					if (float4(0.0078125,0.0078125,128,128).z == 1024) mipCount2 = 10;
					if (float4(0.0078125,0.0078125,128,128).z == 512) mipCount2 = 9;
					if (float4(0.0078125,0.0078125,128,128).z == 256) mipCount2 = 8;
					if (float4(0.0078125,0.0078125,128,128).z == 128) mipCount2 = 7;
					if (float4(0.0078125,0.0078125,128,128).z == 64) mipCount2 = 6;
					if (float4(0.0078125,0.0078125,128,128).z == 32) mipCount2 = 5;
				...
				{
					matcap2.rgb = hueShift(matcap2.rgb, (0.0 /*_Matcap2HueShift*/) + _Time.x * (0.0 /*_Matcap2HueShiftSpeed*/), (0.0 /*_Matcap2HueShiftColorSpace*/), (1.0 /*_Matcap2HueSelectOrShift*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.25 /*_Matcap2Multiply*/), (0.25 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP2
				matcapALD.matcapALEnabled = (1.0 /*_Matcap2ALEnabled*/);
				matcapALD.matcapALAlphaAddBand = (0.0 /*_Matcap2ALAlphaAddBand*/);
				matcapALD.matcapALAlphaAdd = float4(0,0,0,0);
				matcapALD.matcapALEmissionAddBand = (2.0 /*_Matcap2ALEmissionAddBand*/);
				matcapALD.matcapALEmissionAdd = float4(0,0.2,0,0);
				...
				#if defined(PROP_MATCAP3) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_Matcap3UVMode*/), (1.0 /*_Matcap3UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap3Rotation*/), (0.5 /*_Matcap3Border*/), normal2, poiCam, poiLight, poiMesh, (1.0 /*_Matcap3Normal*/), matcapALD);
				...
				{
					matcap3.rgb = hueShift(matcap3.rgb, (0.0 /*_Matcap3HueShift*/) + _Time.x * (0.0 /*_Matcap3HueShiftSpeed*/), (0.0 /*_Matcap3HueShiftColorSpace*/), (1.0 /*_Matcap3HueSelectOrShift*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.25 /*_Matcap3Multiply*/), (0.25 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef POI_MATCAP3
				matcapALD.matcapALEnabled = (1.0 /*_Matcap3ALEnabled*/);
				matcapALD.matcapALAlphaAddBand = (0.0 /*_Matcap3ALAlphaAddBand*/);
				matcapALD.matcapALAlphaAdd = float4(0,0,0,0);
				matcapALD.matcapALEmissionAddBand = (2.0 /*_Matcap3ALEmissionAddBand*/);
				matcapALD.matcapALEmissionAdd = float4(0,0.2,0,0);
				matcapALD.matcapALIntensityAddBand = (0.0 /*_Matcap3ALIntensityAddBand*/);
				matcapALD.matcapALIntensityAdd = float4(0,0,0,0);
				matcapALD.matcapALChronoPanType = (0.0 /*_Matcap3ALChronoPanType*/);
				matcapALD.matcapALChronoPanBand = (0.0 /*_Matcap3ALChronoPanBand*/);
				matcapALD.matcapALChronoPanSpeed = (0.0 /*_Matcap3ALChronoPanSpeed*/);
				float3 normal3 = lerp(poiMesh.normals[0], poiMesh.normals[1], (1.0 /*_Matcap4Normal*/));
				#if defined(PROP_MATCAP4) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_Matcap4UVMode*/), (1.0 /*_Matcap4UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap4Rotation*/), (0.5 /*_Matcap4Border*/), normal3, poiCam, poiLight, poiMesh, (1.0 /*_Matcap4Normal*/), matcapALD);
				if ((0.0 /*_Matcap4SmoothnessEnabled*/))
				{
					float mipCount4 = 9;
					if (float4(0.0078125,0.0078125,128,128).z == 8192) mipCount4 = 13;
					if (float4(0.0078125,0.0078125,128,128).z == 4096) mipCount4 = 12;
					if (float4(0.0078125,0.0078125,128,128).z == 2048) mipCount4 = 11;
					if (float4(0.0078125,0.0078125,128,128).z == 1024) mipCount4 = 10;
					if (float4(0.0078125,0.0078125,128,128).z == 512) mipCount4 = 9;
					if (float4(0.0078125,0.0078125,128,128).z == 256) mipCount4 = 8;
					if (float4(0.0078125,0.0078125,128,128).z == 128) mipCount4 = 7;
					if (float4(0.0078125,0.0078125,128,128).z == 64) mipCount4 = 6;
					if (float4(0.0078125,0.0078125,128,128).z == 32) mipCount4 = 5;
					float matcap4Smoothness = (1.0 /*_Matcap4Smoothness*/);
					if ((0.0 /*_Matcap4MaskSmoothnessApply*/))
					{
						#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
						matcap4Smoothness *= POI2D_SAMPLER_PAN(_Matcap4Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap4MaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(3.0 /*_Matcap4MaskSmoothnessChannel*/)];
						#endif
					}
					matcap4Smoothness = (1 - matcap4Smoothness) * mipCount4;
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap4, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap4), matcap4Smoothness) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,1,1,1).a);
				}
				else
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4)) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,1,1,1).a);
				}
				#else
				matcap4 = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,1,1,1).a);
				#endif
				matcapIntensity = (1.0 /*_Matcap4Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				#ifndef POI_GRABPASS
				matcap4.rgb = lerp(matcap4.rgb, matcap4.rgb * poiFragData.baseColor.rgb, (0.0 /*_Matcap4BaseColorMix*/));
				#endif
				#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
				matcap4Mask = POI2D_SAMPLER_PAN(_Matcap4Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap4MaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_Matcap4MaskChannel*/)];
				#else
				matcap4Mask = 1;
				#endif
				if ((0.0 /*_Matcap4MaskInvert*/))
				{
					matcap4Mask = 1 - matcap4Mask;
				}
				#ifdef TPS_Penetrator
				if ((0.0 /*_Matcap4TPSDepthEnabled*/))
				{
					matcap4Mask = lerp(0, matcap4Mask * TPSBufferedDepth(poiMesh.localPos, poiMesh.vertexColor), (1.0 /*_Matcap4TPSMaskStrength*/));
				}
				#endif
				poiFragData.alpha *= lerp(1, matcap4.a, matcap4Mask * (0.0 /*_Matcap4AlphaOverride*/));
				if ((0.0 /*_Matcap4HueShiftEnabled*/))
				{
					matcap4.rgb = hueShift(matcap4.rgb, (0.0 /*_Matcap4HueShift*/) + _Time.x * (0.0 /*_Matcap4HueShiftSpeed*/), (0.0 /*_Matcap4HueShiftColorSpace*/), (1.0 /*_Matcap4HueSelectOrShift*/));
				}
				if ((0 /*_Matcap4ApplyToAlphaEnabled*/))
				{
					float matcap4AlphaApplyValue = dot(matcap4.rgb, float3(0.299, 0.587, 0.114)); // Greyscale
					if ((0 /*_Matcap4ApplyToAlphaSourceBlend*/) == 1) // Max
					{
						matcap4AlphaApplyValue = poiMax(matcap4.rgb);
					}
					if ((0 /*_Matcap4ApplyToAlphaBlendType*/) == 0) // Add
					{
						poiFragData.alpha += lerp(0, matcap4AlphaApplyValue, (1.0 /*_Matcap4ApplyToAlphaBlending*/));
						poiFragData.alpha = saturate(poiFragData.alpha);
					}
					if ((0 /*_Matcap4ApplyToAlphaBlendType*/) == 1) // Multiply
					{
						poiFragData.alpha *= lerp(1, matcap4AlphaApplyValue, (1.0 /*_Matcap4ApplyToAlphaBlending*/));
					}
				}
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.25 /*_Matcap4Multiply*/), (0.25 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif

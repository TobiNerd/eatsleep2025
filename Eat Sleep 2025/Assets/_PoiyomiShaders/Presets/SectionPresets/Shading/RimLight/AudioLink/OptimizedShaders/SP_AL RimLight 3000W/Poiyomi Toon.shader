Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/5db7e0ca7bf8eb144ae38ccdfb03c04d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				AudioLinkRimWidthAdd = float4(0,0.3,0,0);
				AudioLinkRimEmissionBand = (2.0 /*_AudioLinkRimEmissionBand*/);
				AudioLinkRimEmissionAdd = float4(0,8,0,0);
				AudioLinkRimBrightnessBand = (3.0 /*_AudioLinkRimBrightnessBand*/);
				AudioLinkRimBrightnessAdd = float4(0,8,0,0);
				#endif
				...
				#ifdef _RIM2STYLE_POIYOMI
				#if defined(PROP_RIM2MASK) || !defined(OPTIMIZER_ENABLED)
				float4 rim2MaskAndBias = POI2D_SAMPLER_PAN(_Rim2Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Rim2MaskUV*/)], float4(0,0,0,0)), float4(0,0,0,0));
				...
				AudioLinkRim2WidthAdd = float4(0,0.3,0,0);
				AudioLinkRim2EmissionBand = (2.0 /*_AudioLinkRim2EmissionBand*/);
				AudioLinkRim2EmissionAdd = float4(0,8,0,0);
				AudioLinkRim2BrightnessBand = (3.0 /*_AudioLinkRim2BrightnessBand*/);
				AudioLinkRim2BrightnessAdd = float4(0,8,0,0);
				#endif

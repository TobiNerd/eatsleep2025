Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/29d17db0a4cb270459ef013577be02dd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				AudioLinkRimWidthAdd = float4(0,0.2,0,0);
				AudioLinkRimEmissionBand = (2.0 /*_AudioLinkRimEmissionBand*/);
				AudioLinkRimEmissionAdd = float4(0,1,0,0);
				AudioLinkRimBrightnessBand = (3.0 /*_AudioLinkRimBrightnessBand*/);
				AudioLinkRimBrightnessAdd = float4(0,1,0,0);
				#endif
				...
				AudioLinkRim2WidthAdd = float4(0,0.2,0,0);
				AudioLinkRim2EmissionBand = (2.0 /*_AudioLinkRim2EmissionBand*/);
				AudioLinkRim2EmissionAdd = float4(0,1,0,0);
				AudioLinkRim2BrightnessBand = (3.0 /*_AudioLinkRim2BrightnessBand*/);
				AudioLinkRim2BrightnessAdd = float4(0,1,0,0);
				#endif

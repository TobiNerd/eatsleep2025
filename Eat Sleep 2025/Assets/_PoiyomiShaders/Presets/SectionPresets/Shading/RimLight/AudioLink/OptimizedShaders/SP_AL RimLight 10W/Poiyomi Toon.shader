Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/59e992582e0872c4486edd6e6948399b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6231937,0.3763272,0.2260373,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.6231937,0.3763272,0.2260373,1).a;
				...
				#ifdef POI_AUDIOLINK
				AudioLinkRimWidthBand = (1.0 /*_AudioLinkRimWidthBand*/);
				AudioLinkRimWidthAdd = float4(0,0.1,0,0);
				AudioLinkRimEmissionBand = (2.0 /*_AudioLinkRimEmissionBand*/);
				AudioLinkRimEmissionAdd = float4(0,0.1,0,0);
				AudioLinkRimBrightnessBand = (3.0 /*_AudioLinkRimBrightnessBand*/);
				AudioLinkRimBrightnessAdd = float4(0,0.1,0,0);
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (1.0 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.8 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.2941556,0.2941556,0.2941556,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (1.0 /*_RimHueSelectOrShift*/), (0.0 /*_RimHueShiftSpeed*/),  (0.25 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.368 /*_RimBaseColorMix*/), (1.0 /*_RimBrightness*/), (0.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef POI_RIM2
				#ifdef _RIM2STYLE_POIYOMI
				...
				#ifdef POI_AUDIOLINK
				AudioLinkRim2WidthBand = (1.0 /*_AudioLinkRim2WidthBand*/);
				AudioLinkRim2WidthAdd = float4(0,0.1,0,0);
				AudioLinkRim2EmissionBand = (2.0 /*_AudioLinkRim2EmissionBand*/);
				AudioLinkRim2EmissionAdd = float4(0,0.1,0,0);
				AudioLinkRim2BrightnessBand = (3.0 /*_AudioLinkRim2BrightnessBand*/);
				AudioLinkRim2BrightnessAdd = float4(0,0.1,0,0);
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRim2Light*/), (0.0 /*_Rim2LightingInvert*/), (1.0 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (0.0 /*_Rim2ShadowToggle*/), (0.8 /*_Rim2Width*/), (1.0 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(0.2941556,0.2941556,0.2941556,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftColorSpace*/), (1.0 /*_Rim2HueSelectOrShift*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.25 /*_Rim2Sharpness*/), (0.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (0.368 /*_Rim2BaseColorMix*/), (1.0 /*_Rim2Brightness*/), (0.0 /*_RimPoi2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, rim2Bias, (0.0 /*_Rim2BiasIntensity*/), (0 /*_Rim2ApplyAlpha*/), (1.0 /*_Rim2ApplyAlphaBlend*/));
				#endif
				#endif

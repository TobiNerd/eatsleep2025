Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9392d94f15870434facaa649d54973f0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_LightingColorMode*/) == 0) // Poi Custom Light Color
				{
					...
					poiLight.indirectColor = BetterSH9(float4(lerp(0, poiMesh.normals[1], (0.333 /*_LightingIndirectUsesNormals*/)), 1));
				}

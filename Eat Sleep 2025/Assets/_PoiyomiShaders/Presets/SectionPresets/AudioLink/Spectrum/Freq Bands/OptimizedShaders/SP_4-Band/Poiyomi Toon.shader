Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/dcfe7452207d2404e86c5ca30156ae5d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskBand = (4.0 /*_ALDecalBandStep*/) != 0.0 ? floor(maskX * (4.0 /*_ALDecalBandStep*/)) / (4.0 /*_ALDecalBandStep*/) : maskX;
				...
				if ((0.0 /*_ALDecalShapeClip*/))
				{
					...
					if ((4.0 /*_ALDecalBandStep*/) != 0.0) audioLinkMask.b = frac(maskX * (4.0 /*_ALDecalBandStep*/) + bandth * 0.5) < bandth ? 0.0 : audioLinkMask.b;
				}

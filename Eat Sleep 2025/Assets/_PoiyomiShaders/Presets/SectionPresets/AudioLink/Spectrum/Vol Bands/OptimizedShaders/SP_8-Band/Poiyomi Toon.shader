Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/be96e40be3814e84fbca071cf6782a66"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = (8.0 /*_ALDecalVolumeStep*/) != 0.0 ? floor(maskY * (8.0 /*_ALDecalVolumeStep*/)) / (8.0 /*_ALDecalVolumeStep*/) : maskY;
				...
				if ((0.0 /*_ALDecalShapeClip*/))
				{
					...
					if ((8.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (8.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c616aa2d7967623489243ae874323c90"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = (4.0 /*_ALDecalVolumeStep*/) != 0.0 ? floor(maskY * (4.0 /*_ALDecalVolumeStep*/)) / (4.0 /*_ALDecalVolumeStep*/) : maskY;
				...
				if ((0.0 /*_ALDecalShapeClip*/))
				{
					...
					if ((4.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (4.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;

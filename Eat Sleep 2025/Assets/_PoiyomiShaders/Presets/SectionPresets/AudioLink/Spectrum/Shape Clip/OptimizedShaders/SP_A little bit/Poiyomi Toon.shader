Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/79e9030983879a946865745af96856b7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = (12.0 /*_ALDecalVolumeStep*/) != 0.0 ? floor(maskY * (12.0 /*_ALDecalVolumeStep*/)) / (12.0 /*_ALDecalVolumeStep*/) : maskY;
				float maskBand = (12.0 /*_ALDecalBandStep*/) != 0.0 ? floor(maskX * (12.0 /*_ALDecalBandStep*/)) / (12.0 /*_ALDecalBandStep*/) : maskX;
				...
				{
					float volumeth = (0.95 /*_ALDecalShapeClipVolumeWidth*/);
					if ((12.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (12.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;
					float bandwidth = (0.0 /*_ALDecalUVMode*/) == 1 ? (0.95 /*_ALDecalShapeClipBandWidth*/) / aluv.y : (0.95 /*_ALDecalShapeClipBandWidth*/);
					float bandth = 1.0 - bandwidth;
					if ((12.0 /*_ALDecalBandStep*/) != 0.0) audioLinkMask.b = frac(maskX * (12.0 /*_ALDecalBandStep*/) + bandth * 0.5) < bandth ? 0.0 : audioLinkMask.b;
				}
				...
				float3 lowColor = float4(0.4019778,1,0,1).rgb * poiThemeColor(poiMods, float4(0.4019778,1,0,1).rgb, (0.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0.4019779,1,0,1).rgb * poiThemeColor(poiMods, float4(0.4019779,1,0,1).rgb, (0.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(0.4019779,1,0,1).rgb * poiThemeColor(poiMods, float4(0.4019779,1,0,1).rgb, (0.0 /*_ALDecalVolumeColorHighThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (0.1 /*_ALDecalLowEmission*/), midColor * (1.0 /*_ALDecalMidEmission*/), saturate(volumeColorSrc * 2));
				emissionColor = lerp(emissionColor, highColor * (3.0 /*_ALDecalHighEmission*/), saturate(volumeColorSrc * 2 - 1));

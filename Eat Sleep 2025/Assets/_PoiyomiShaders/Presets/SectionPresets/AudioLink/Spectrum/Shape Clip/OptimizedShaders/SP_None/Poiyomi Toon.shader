Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/2faedc967d87bf84a85ef450ba101864"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				{
					float volumeth = (0.9 /*_ALDecalShapeClipVolumeWidth*/);
					if ((12.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (12.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;
					float bandwidth = (0.0 /*_ALDecalUVMode*/) == 1 ? (0.9 /*_ALDecalShapeClipBandWidth*/) / aluv.y : (0.9 /*_ALDecalShapeClipBandWidth*/);

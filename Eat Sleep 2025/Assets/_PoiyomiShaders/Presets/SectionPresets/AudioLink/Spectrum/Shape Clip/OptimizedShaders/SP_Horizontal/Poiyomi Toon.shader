Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/07dddbdf73d66fc4ca8b64cf08c75eac"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_ALDecalShapeClip*/))
				{
					...
					float bandwidth = (0.0 /*_ALDecalUVMode*/) == 1 ? (1.0 /*_ALDecalShapeClipBandWidth*/) / aluv.y : (1.0 /*_ALDecalShapeClipBandWidth*/);

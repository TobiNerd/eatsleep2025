Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e521e7368b5839d4d927e507e15593eb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = (10.0 /*_ALDecalVolumeStep*/) != 0.0 ? floor(maskY * (10.0 /*_ALDecalVolumeStep*/)) / (10.0 /*_ALDecalVolumeStep*/) : maskY;
				float maskBand = (10.0 /*_ALDecalBandStep*/) != 0.0 ? floor(maskX * (10.0 /*_ALDecalBandStep*/)) / (10.0 /*_ALDecalBandStep*/) : maskX;
				...
				if ((1.0 /*_ALDecalShapeClip*/))
				{
					float volumeth = (0.586 /*_ALDecalShapeClipVolumeWidth*/);
					if ((10.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (10.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;
					float bandwidth = (0.0 /*_ALDecalUVMode*/) == 1 ? (0.879 /*_ALDecalShapeClipBandWidth*/) / aluv.y : (0.879 /*_ALDecalShapeClipBandWidth*/);
					float bandth = 1.0 - bandwidth;
					if ((10.0 /*_ALDecalBandStep*/) != 0.0) audioLinkMask.b = frac(maskX * (10.0 /*_ALDecalBandStep*/) + bandth * 0.5) < bandth ? 0.0 : audioLinkMask.b;
				}
				...
				float audioVal = audioTexture.b * (1.0 /*_ALDecalVolume*/) * lerp((5.0 /*_ALDecalBaseBoost*/), (1.0 /*_ALDecalTrebleBoost*/), audioLinkMask.g);
				...
				float3 lowColor = float4(1,0.6920712,0.4479884,1).rgb * poiThemeColor(poiMods, float4(1,0.6920712,0.4479884,1).rgb, (0.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(1,0.693872,0.4507858,1).rgb * poiThemeColor(poiMods, float4(1,0.693872,0.4507858,1).rgb, (0.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(1,0.693872,0.4507858,1).rgb * poiThemeColor(poiMods, float4(1,0.693872,0.4507858,1).rgb, (0.0 /*_ALDecalVolumeColorHighThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (2.0 /*_ALDecalLowEmission*/), midColor * (2.0 /*_ALDecalMidEmission*/), saturate(volumeColorSrc * 2));
				emissionColor = lerp(emissionColor, highColor * (2.0 /*_ALDecalHighEmission*/), saturate(volumeColorSrc * 2 - 1));
				#if defined(POI_PASS_BASE) || defined(POI_PASS_ADD)
				poiFragData.emission += emissionColor * audioLinkValue;
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, volumeColor * colorAndMask.rgb, (8.0 /*_ALDecalBlendType*/)), saturate((1.0 /*_ALDecalBlendAlpha*/) * audioLinkValue));
				#endif

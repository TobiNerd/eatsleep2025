Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/34b907ecea29f974aaf32f618e246a5b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, (0.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, (0.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(0.6514058,0.6514058,1,1).rgb * poiThemeColor(poiMods, float4(0.6514058,0.6514058,1,1).rgb, (0.0 /*_ALDecalVolumeColorHighThemeIndex*/));

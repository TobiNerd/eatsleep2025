Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4b2f66c1368172243a40266842df0569"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(1,0.1587067,0.002428216,1).rgb * poiThemeColor(poiMods, float4(1,0.1587067,0.002428216,1).rgb, (0.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(1,0.7449472,0.5549318,1).rgb * poiThemeColor(poiMods, float4(1,0.7449472,0.5549318,1).rgb, (0.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(0.3005438,0.4286905,0.8148468,1).rgb * poiThemeColor(poiMods, float4(0.3005438,0.4286905,0.8148468,1).rgb, (0.0 /*_ALDecalVolumeColorHighThemeIndex*/));

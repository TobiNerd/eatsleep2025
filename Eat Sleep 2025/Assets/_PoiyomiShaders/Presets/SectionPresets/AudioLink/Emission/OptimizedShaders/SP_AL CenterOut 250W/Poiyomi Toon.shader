Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/04a9abb44cb287847ba9f0b70a506c85"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.9 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,10,0,0), (1.0 /*_EmissionAL0Enabled*/), (1.0 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.9 /*_AudioLinkEmission1CenterOutSize*/), (1.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,10,0,0), (1.0 /*_EmissionAL1Enabled*/), (1.0 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, (0.9 /*_AudioLinkEmission2CenterOutSize*/), (1.0 /*_AudioLinkEmission2CenterOutBand*/), float4(0,10,0,0), (1.0 /*_EmissionAL2Enabled*/), (1.0 /*_AudioLinkEmission2CenterOutDuration*/));
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.9 /*_AudioLinkEmission3CenterOutSize*/), (1.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0,10,0,0), (1.0 /*_EmissionAL3Enabled*/), (1.0 /*_AudioLinkEmission3CenterOutDuration*/));

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6a19a992ae69bc54180fe67a2801d2d9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,20,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.0 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL0Enabled*/), (1.0 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,20,0,0), (0.0 /*_EmissionAL1StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL1MultipliersBand*/), (1.0 /*_EmissionAL1Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.0 /*_AudioLinkEmission1CenterOutSize*/), (1.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL1Enabled*/), (1.0 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength2, float4(0,20,0,0), (0.0 /*_EmissionAL2StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL2MultipliersBand*/), (1.0 /*_EmissionAL2Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, (0.0 /*_AudioLinkEmission2CenterOutSize*/), (1.0 /*_AudioLinkEmission2CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL2Enabled*/), (1.0 /*_AudioLinkEmission2CenterOutDuration*/));
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,20,0,0), (0.0 /*_EmissionAL3StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL3MultipliersBand*/), (1.0 /*_EmissionAL3Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.0 /*_AudioLinkEmission3CenterOutSize*/), (1.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL3Enabled*/), (1.0 /*_AudioLinkEmission3CenterOutDuration*/));

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e304774b36de29a49bd67576551ca746"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void initPoiAudioLink(inout PoiMods poiMods)
			{
				...
				if ((1.0 /*_AudioLinkBandOverridesEnabled*/))
				{
					poiMods.audioLinkAvailable = true;
					poiMods.audioLink[0] = float4(1,1,1,1).x;
					poiMods.audioLink[1] = float4(1,1,1,1).y;
					poiMods.audioLink[2] = float4(1,1,1,1).z;
					poiMods.audioLink[3] = float4(1,1,1,1).w;
				}
			}
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.9 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,1,0,0), (1.0 /*_EmissionAL0Enabled*/), (1.0 /*_AudioLinkEmission0CenterOutDuration*/));
				...
				#else
				float mixBaseColor = (0.0 /*_EmissionBaseColorAsMap*/);
				#endif
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0,0,0), (0.0 /*_EmissionAL1StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL1MultipliersBand*/), (1.0 /*_EmissionAL1Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.9 /*_AudioLinkEmission1CenterOutSize*/), (1.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,0.5,0,0), (1.0 /*_EmissionAL1Enabled*/), (1.0 /*_AudioLinkEmission1CenterOutDuration*/));
				...
				float mixBaseColor = 0;
				#else
				float mixBaseColor = (0.0 /*_EmissionBaseColorAsMap1*/);
				#endif
				#if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled1*/))
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				if ((0.0 /*_EmissionHueShiftEnabled1*/))
				{
					emissionColor1 = hueShift(emissionColor1, frac((0.0 /*_EmissionHueShift1*/) + (0.0 /*_EmissionHueShiftSpeed1*/) * _Time.x), (0.0 /*_EmissionHueShiftColorSpace1*/), (1.0 /*_EmissionHueSelectOrShift1*/));
					emissionColor1 = lerp(emissionColor1, dot(emissionColor1, float3(0.3, 0.59, 0.11)), - ((0.0 /*_EmissionSaturation1*/)));
				}
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength2, float4(0,0,0,0), (0.0 /*_EmissionAL2StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL2MultipliersBand*/), (1.0 /*_EmissionAL2Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, (0.9 /*_AudioLinkEmission2CenterOutSize*/), (1.0 /*_AudioLinkEmission2CenterOutBand*/), float4(0,0.5,0,0), (1.0 /*_EmissionAL2Enabled*/), (1.0 /*_AudioLinkEmission2CenterOutDuration*/));
				float glowInTheDarkMultiplier2 = calculateGlowInTheDark((1.0 /*_GITDEMinLight2*/), (1.0 /*_GITDEMaxLight2*/), (0.0 /*_GITDEMinEmissionMultiplier2*/), (0.0 /*_GITDEMaxEmissionMultiplier2*/), (0.0 /*_EnableGITDEmission2*/), (1.0 /*_GITDEWorldOrMesh2*/), poiLight);
				#ifdef POI_GRABPASS
				float mixBaseColor = 0;
				#else
				float mixBaseColor = (0.0 /*_EmissionBaseColorAsMap2*/);
				#endif
				#if defined(PROP_EMISSIONMAP2) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled2*/))
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				if ((0.0 /*_EmissionHueShiftEnabled2*/))
				{
					emissionColor2 = hueShift(emissionColor2, frac((0.0 /*_EmissionHueShift2*/) + (0.0 /*_EmissionHueShiftSpeed2*/) * _Time.x), (0.0 /*_EmissionHueShiftColorSpace2*/), (1.0 /*_EmissionHueSelectOrShift2*/));
					emissionColor2 = lerp(emissionColor2, dot(emissionColor2, float3(0.3, 0.59, 0.11)), - ((0.0 /*_EmissionSaturation2*/)));
				}
				#if defined(PROP_EMISSIONMASK2) || !defined(OPTIMIZER_ENABLED)
				...
				{
					emissionMask2 = maskBlend(emissionMask2, poiMods.globalMask[(0.0 /*_EmissionMask2GlobalMask*/) - 1], (2.0 /*_EmissionMask2GlobalMaskBlendType*/));
				}
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,0,0,0), (0.0 /*_EmissionAL3StrengthBand*/), float4(1,1,0,0), (0.0 /*_EmissionAL3MultipliersBand*/), (1.0 /*_EmissionAL3Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.9 /*_AudioLinkEmission3CenterOutSize*/), (1.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0,0.5,0,0), (1.0 /*_EmissionAL3Enabled*/), (1.0 /*_AudioLinkEmission3CenterOutDuration*/));
				float glowInTheDarkMultiplier3 = calculateGlowInTheDark((0.0 /*_GITDEMinLight3*/), (1.0 /*_GITDEMaxLight3*/), (1.0 /*_GITDEMinEmissionMultiplier3*/), (0.0 /*_GITDEMaxEmissionMultiplier3*/), (0.0 /*_EnableGITDEmission3*/), (0.0 /*_GITDEWorldOrMesh3*/), poiLight);
				#ifdef POI_GRABPASS
				float mixBaseColor = 0;
				#else
				float mixBaseColor = (0.0 /*_EmissionBaseColorAsMap3*/);
				#endif
				#if defined(PROP_EMISSIONMAP3) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled3*/))
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				if ((0.0 /*_ScrollingEmission3*/))
				{
					...
					if ((0.0 /*_EmissionScrollingUseCurve3*/))
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE3) || !defined(OPTIMIZER_ENABLED)
				...
				if ((0.0 /*_EmissionHueShiftEnabled3*/))
				{
					emissionColor3 = hueShift(emissionColor3, frac((0.0 /*_EmissionHueShift3*/) + (0.0 /*_EmissionHueShiftSpeed3*/) * _Time.x), (0.0 /*_EmissionHueShiftColorSpace3*/), (1.0 /*_EmissionHueSelectOrShift3*/));
					emissionColor3 = lerp(emissionColor3, dot(emissionColor3, float3(0.3, 0.59, 0.11)), - ((0.0 /*_EmissionSaturation3*/)));
				}
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
				...
				if ((0.0 /*_EmissionMask3GlobalMask*/) > 0)
				{
					emissionMask3 = maskBlend(emissionMask3, poiMods.globalMask[(0.0 /*_EmissionMask3GlobalMask*/) - 1], (2.0 /*_EmissionMask3GlobalMaskBlendType*/));
				}
				...
				return emission3 * (0.0 /*_EmissionReplace3*/);
			}
			#endif

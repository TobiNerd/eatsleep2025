Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/67ca07f5ecca1804ea63f70fdfa360f5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					flipBookMask = maskBlend(flipBookMask, poiMods.globalMask[(0.0 /*_FlipbookMaskGlobalMask*/)-1], (2.0 /*_FlipbookMaskGlobalMaskBlendType*/));
				}
				...
				float2 uv = frac(poiMesh.uv[(0.0 /*_FlipbookTexArrayUV*/)] +_Time.x * float4(0,0,0,1).xy);
				...
				{
					if ((14.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = ((_Time.y / (1 / (14.0 /*_FlipbookFPS*/))) + (0.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				if (poiMods.audioLinkAvailable)
				{
					if ((1.0 /*_FlipbookChronotensityEnabled*/))
					{
						currentFrame += AudioLinkGetChronoTime((1.0 /*_FlipbookChronoType*/), (1.0 /*_FlipbookChronotensityBand*/)) * (8.0 /*_FlipbookChronotensitySpeed*/);
					}
				...
				{
					flipBookPixel.rgb = hueShift(flipBookPixel.rgb, (0.0 /*_FlipbookHueShift*/) + _Time.x * (0.0 /*_FlipbookHueShiftSpeed*/), (0.0 /*_FlipbookHueShiftColorSpace*/), (1.0 /*_FlipbookHueSelectOrShift*/));
				}
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, flipBookPixel.rgb, (8.0 /*_FlipbookBlendType*/)), flipBookPixel.a * float4(1,1,1,1).a * (1.0 /*_FlipbookReplace*/) * flipBookMask * flipbookAlpha);
				float flipbookEmissionStrength = (4.0 /*_FlipbookEmissionStrength*/);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
					flipbookEmissionStrength += max(lerp(float4(0,0.5,0,0).x, float4(0,0.5,0,0).y, poiMods.audioLink[(2.0 /*_AudioLinkFlipbookEmissionBand*/)]), 0);
				}
				#endif

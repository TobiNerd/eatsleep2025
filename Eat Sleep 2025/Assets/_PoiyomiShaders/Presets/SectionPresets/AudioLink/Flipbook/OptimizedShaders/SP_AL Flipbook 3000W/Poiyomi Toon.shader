Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1b554d513234cef468b0778acdec93c5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (poiMods.audioLinkAvailable)
				{
					...
					{
						currentFrame += AudioLinkGetChronoTime((1.0 /*_FlipbookChronoType*/), (1.0 /*_FlipbookChronotensityBand*/)) * (24.0 /*_FlipbookChronotensitySpeed*/);
					}
				...
				if (poiMods.audioLinkAvailable)
				{
					flipbookEmissionStrength += max(lerp(float4(0,20,0,0).x, float4(0,20,0,0).y, poiMods.audioLink[(2.0 /*_AudioLinkFlipbookEmissionBand*/)]), 0);
				}
				#endif

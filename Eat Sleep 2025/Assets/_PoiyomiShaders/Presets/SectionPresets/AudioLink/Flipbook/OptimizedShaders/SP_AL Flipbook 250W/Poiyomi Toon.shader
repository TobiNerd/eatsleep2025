Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4ccb17d0fa7ada74190025227a9dc06d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (poiMods.audioLinkAvailable)
				{
					...
					{
						currentFrame += AudioLinkGetChronoTime((1.0 /*_FlipbookChronoType*/), (1.0 /*_FlipbookChronotensityBand*/)) * (20.0 /*_FlipbookChronotensitySpeed*/);
					}
				...
				if (poiMods.audioLinkAvailable)
				{
					flipbookEmissionStrength += max(lerp(float4(0,6,0,0).x, float4(0,6,0,0).y, poiMods.audioLink[(2.0 /*_AudioLinkFlipbookEmissionBand*/)]), 0);
				}
				#endif

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4ff9dc5869e7e96429bf801083e28cfe"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				reflectionMask *= (0.2 /*_MochieReflectionStrength*/);
				specularMask *= (0.2 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.0396819,0.0396819,0.0396819,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.0396819,0.0396819,0.0396819,1).a;

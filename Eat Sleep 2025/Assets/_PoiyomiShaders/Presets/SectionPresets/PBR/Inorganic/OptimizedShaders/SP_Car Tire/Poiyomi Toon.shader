Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/b894de3c86ef0604eaf447838ba9863b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.6 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.25 /*_MochieReflectionStrength*/);
				specularMask *= (0.25 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.02198094,0.02198094,0.02198094,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.02198094,0.02198094,0.02198094,1).a;

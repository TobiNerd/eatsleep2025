Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/0735bea753100c44594030ead486c757"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.0 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.001 /*_MochieReflectionStrength*/);
				specularMask *= (0.001 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.0007739938,0.0007739938,0.0007739938,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.0007739938,0.0007739938,0.0007739938,1).a;

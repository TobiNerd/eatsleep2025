Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/85d2476e67e6610419e0265098613b3b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				reflectionMask *= (0.4 /*_MochieReflectionStrength*/);
				specularMask *= (0.4 /*_MochieSpecularStrength*/);
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.965 /*_ClearCoatSmoothness*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1169707,0.05471584,0.05471584,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1169707,0.05471584,0.05471584,1).a;

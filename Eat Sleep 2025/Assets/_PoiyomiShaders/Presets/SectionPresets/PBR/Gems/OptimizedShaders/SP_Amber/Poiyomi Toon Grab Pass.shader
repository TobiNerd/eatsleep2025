Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Grab Pass/c860e18c2caf11841bc2cfb7998ea5aa"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGrabEffects(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					grabpassColor = Refraction((1.55 /*_RefractionIndex*/), (0.0 /*_RefractionChromaticAberattion*/), poiMesh, poiCam, poiMods, poiLight, poiFragData).rgb;
				}
				else
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.701102,0.2272337,0.001517637,0).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.701102,0.2272337,0.001517637,0).a;

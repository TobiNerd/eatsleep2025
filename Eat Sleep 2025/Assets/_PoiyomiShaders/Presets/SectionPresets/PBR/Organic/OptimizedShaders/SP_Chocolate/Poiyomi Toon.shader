Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/15fd51267d5c2464aa01a0182e3554a4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.7 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.5 /*_MochieReflectionStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1626472,0.09127647,0.06048608,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1626472,0.09127647,0.06048608,1).a;

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/5a0731fb35950a94b8080e2fc98fd21c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_MainHueShiftToggle*/) == 1)
				{
					...
					{
						poiFragData.baseColor = lerp(poiFragData.baseColor, hueShift(poiFragData.baseColor, shift + (3.0 /*_MainHueShiftSpeed*/) * _Time.x, (0.0 /*_MainHueShiftColorSpace*/), (1.0 /*_MainHueShiftSelectOrShift*/)), hueShiftAlpha.r);
					}
					else
					{
						poiFragData.baseColor = hueShift(poiFragData.baseColor, frac((shift - (1 - hueShiftAlpha.r) + (3.0 /*_MainHueShiftSpeed*/) * _Time.x)), (0.0 /*_MainHueShiftColorSpace*/), (1.0 /*_MainHueShiftSelectOrShift*/));
					}
				}

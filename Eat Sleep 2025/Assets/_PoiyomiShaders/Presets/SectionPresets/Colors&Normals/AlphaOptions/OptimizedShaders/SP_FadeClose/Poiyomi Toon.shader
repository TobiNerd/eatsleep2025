Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9d3374f93cc20444ea719f89dd54fa40"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_AlphaDistanceFade*/))
				{
					...
					float distanceFadeMultiplier = lerp((0.0 /*_AlphaDistanceFadeMinAlpha*/), (1.0 /*_AlphaDistanceFadeMaxAlpha*/), smoothstep((2.0 /*_AlphaDistanceFadeMin*/), (4.0 /*_AlphaDistanceFadeMax*/), distance(position, poiCam.worldPos)));

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d8998f2d34f7a3c45b228d16870516e7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_AlphaDistanceFade*/))
				{
					float3 position = (0.0 /*_AlphaDistanceFadeType*/) ? poiMesh.worldPos : poiMesh.objectPosition;
					float distanceFadeMultiplier = lerp((1.0 /*_AlphaDistanceFadeMinAlpha*/), (0.0 /*_AlphaDistanceFadeMaxAlpha*/), smoothstep((2.0 /*_AlphaDistanceFadeMin*/), (4.0 /*_AlphaDistanceFadeMax*/), distance(position, poiCam.worldPos)));
					if ((0.0 /*_AlphaDistanceFadeGlobalMask*/) > 0)
					{
						distanceFadeMultiplier = lerp(1, distanceFadeMultiplier, poiMods.globalMask[(0.0 /*_AlphaDistanceFadeGlobalMask*/) - 1]);
					}

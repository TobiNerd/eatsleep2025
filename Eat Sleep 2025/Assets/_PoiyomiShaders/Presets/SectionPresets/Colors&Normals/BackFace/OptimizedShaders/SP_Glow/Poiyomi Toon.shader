Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/149f22d578708e749b912f9c811a7977"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(1,0,1,0.5019608);
					...
					#endif
					if ((1.0 /*_BackFaceHueShiftEnabled*/))
					{
						backFaceColor.rgb = hueShift(backFaceColor.rgb, frac((0.0 /*_BackFaceHueShift*/) + (3.0 /*_BackFaceHueShiftSpeed*/) * _Time.x), (0.0 /*_BackFaceShiftColorSpace*/), (1.0 /*_BackFaceHueSelectOrShift*/));
					}
					...
					poiFragData.emission += backFaceColor.rgb * (3.0 /*_BackFaceEmissionStrength*/) * backFaceMask;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.3612137,0.2772259,0.1575434,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.3612137,0.2772259,0.1575434,1).a;

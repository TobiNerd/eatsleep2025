Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/058fbb400267e4440bce13b340c4dc9e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (3.2 /*_OutlinesMaxDistance*/)), (1.0 /*_OutlineFixWidth*/));
				}
				float lineWidth = (0.08 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1322899,0.1084708,0.1729492,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1322899,0.1084708,0.1729492,1).a;
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.08735064,0.08735064,0.08735064,1);
				#ifdef POI_AUDIOLINK

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/3f8642ecde170d8408527738fd5392f4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.126 /*_AlphaMod*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0.1328683,1,0.4745098).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,0.1328683,1,0.4745098).a;
				...
				clip(poiFragData.alpha - (0.14 /*_Cutoff*/));

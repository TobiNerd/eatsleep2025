Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/62a278a074e00c94ba4aa2181a2ae166"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0,0.4,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0,0.4,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0,0.4,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				if ((1.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,-10,0,0).xyz) * (0.5 /*_EmissiveScroll_Interval*/)) + _Time.x * (0.5 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-10,0,0).xyz, (0.5 /*_EmissiveScroll_Velocity*/), (0.5 /*_EmissiveScroll_Interval*/), (3.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
			...
			void applyDepthFX(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					float colorBlendAlpha = lerp((1.0 /*_DepthColorMinValue*/), (0.0 /*_DepthColorMaxValue*/), remapClamped((0.0 /*_DepthColorMinDepth*/), (0.15 /*_DepthColorMaxDepth*/), diff));
					#if defined(PROP_DEPTHTEXTURE) || !defined(OPTIMIZER_ENABLED)
					float2 depthTextureUV = float2(0, 0);
					if ((0.0 /*_DepthTextureUV*/) == 8)
					{
						depthTextureUV = lerp(0, 1, remapClamped((0.0 /*_DepthColorMinDepth*/), (0.15 /*_DepthColorMaxDepth*/), diff));
					}
					else
					{
						depthTextureUV = poiMesh.uv[(0.0 /*_DepthTextureUV*/)];
					}
					float3 depthColor = POI2D_SAMPLER_PAN(_DepthTexture, _MainTex, poiUV(depthTextureUV, float4(1,1,0,0)), float4(0,0,0,0)).rgb * poiThemeColor(poiMods, float4(0.5223939,0,1,1), (0.0 /*_DepthColorThemeIndex*/));
					#else
					float3 depthColor = poiThemeColor(poiMods, float4(0.5223939,0,1,1), (0.0 /*_DepthColorThemeIndex*/));
					#endif
					...
					poiFragData.emission += depthColor * colorBlendAlpha * (4.0 /*_DepthEmissionStrength*/) * depthMask;
				}
				if ((0.0 /*_DepthAlphaToggle*/))
				{
					poiFragData.alpha *= lerp(poiFragData.alpha, saturate(lerp((1.0 /*_DepthAlphaMinValue*/), (0.0 /*_DepthAlphaMaxValue*/), remapClamped((0.0 /*_DepthAlphaMinDepth*/), (1.0 /*_DepthAlphaMaxDepth*/), diff))), depthMask);
				}
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.56 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (1.0 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0,0.1328683,1,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (1.0 /*_RimHueSelectOrShift*/), (0.0 /*_RimHueShiftSpeed*/),  (0.202 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (1.0 /*_RimBrightness*/), (0.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				...
				#endif
				if ((4.0 /*_Mode*/) == POI_MODE_OPAQUE)
				{
				}
				clip(poiFragData.alpha - (0.0 /*_Cutoff*/));
				if ((4.0 /*_Mode*/) == POI_MODE_CUTOUT && !(0.0 /*_AlphaToCoverage*/))
				{
					poiFragData.alpha = 1;
				}
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((4.0 /*_Mode*/) != POI_MODE_TRANSPARENT)
				{

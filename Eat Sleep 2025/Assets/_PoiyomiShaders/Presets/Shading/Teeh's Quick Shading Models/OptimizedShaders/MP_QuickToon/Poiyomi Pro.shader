Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/a9b85a227a5eca54eb8736f6221ed4b3"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.2.16</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(0.01974194,0.01974194,0.2158605,0.2980392);
					...
					#endif
					if ((0.0 /*_BackFaceHueShiftEnabled*/))
					{
						backFaceColor.rgb = hueShift(backFaceColor.rgb, frac((0.0 /*_BackFaceHueShift*/) + (0.0 /*_BackFaceHueShiftSpeed*/) * _Time.x), (0.0 /*_BackFaceShiftColorSpace*/), (1.0 /*_BackFaceHueSelectOrShift*/));
					}
					...
					poiMods.globalEmission = poiMods.globalEmission * (1.0 /*_BackFaceEmissionLimiter*/);
				}
			}
			#endif
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					float passthrough = 0;
					#else
					float passthrough = (0.01 /*_LightingAdditivePassthrough*/);
					#endif
					float2 ToonAddGradient = float2((0.35 /*_LightingAdditiveGradientStart*/), (0.4 /*_LightingAdditiveGradientEnd*/));
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.0 /*_Shadow2ndBorder*/), (0.0 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.0 /*_Shadow3rdBorder*/), (0.0 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.1 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.0 /*_Shadow2ndBorder*/), (0.0 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.0 /*_Shadow3rdBorder*/), (0.0 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.1 /*_ShadowBlur*/) * blurMap.r, (0.1 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				lns = saturate(lns);
				#if defined(PROP_SHADOWSTRENGTHMASK) || !defined(OPTIMIZER_ENABLED)
				float4 shadowStrengthMask = POI2D_SAMPLER_PAN(_ShadowStrengthMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ShadowStrengthMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				float4 shadowStrengthMask = 1;
				#endif
				if((0.0 /*_ShadowMaskType*/) == 1)
				{
					float3 flatN = normalize(mul((float3x3)unity_ObjectToWorld, float3(0.0,0.25,1.0)));//normalize(LIL_MATRIX_M._m02_m12_m22);
					float lnFlat = saturate((dot(flatN, poiLight.direction) + (1.0 /*_ShadowFlatBorder*/)) / (1.0 /*_ShadowFlatBlur*/));
					lns = lerp(lnFlat, lns, shadowStrengthMask.r);
				}
				else if((0.0 /*_ShadowMaskType*/) == 0)
				{
					shadowStrength *= shadowStrengthMask.r;
				}
				float3 indirectColor = 1;
				if (float4(0.6038274,0.6038274,0.6038274,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.6038274,0.6038274,0.6038274,1).rgb;
				}
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(0.4507858,0.09989873,0.09989873,1).rgb * float4(0.4507858,0.09989873,0.09989873,1).a);
				indirectColor = indirectColor * lerp(poiLight.indirectColor, poiLight.directColor, (0.0 /*_LightingIgnoreAmbientColor*/));
				#ifndef POI_PASS_ADD
				indirectColor = lerp(indirectColor, poiLight.directColor, poiLight.indirectColor * (0.666 /*_ShadowEnvStrength*/));
				#endif
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if (lightingMode == 1)
						{
							float2 ToonAddGradient = float2((0.35 /*_LightingAdditiveGradientStart*/), (0.4 /*_LightingAdditiveGradientEnd*/));
							if (ToonAddGradient.x == ToonAddGradient.y) ToonAddGradient.y += 0.0001;
							vertexLighting = max(vertexLighting, lerp(poiLight.vColor[index], poiLight.vColor[index] * (0.01 /*_LightingAdditivePassthrough*/), smoothstep(ToonAddGradient.x, ToonAddGradient.y, 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow);
						}
					}
			...
			{
				float clearCoatMask = (1.0 /*_ClearCoatStrength*/);
				float smoothness = (0.5 /*_ClearCoatSmoothness*/);
				float reflectionMask = (1.0 /*_ClearCoatReflectionStrength*/);
				float specularMask = (1.0 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 PBRMaps = POI2D_SAMPLER_PAN_STOCHASTIC(_ClearCoatMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ClearCoatMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_ClearCoatMapsStochastic*/));
				if ((0.0 /*_ClearCoatMapsClearCoatMaskChannel*/) < 4)
				{
					clearCoatMask *= PBRMaps[(0.0 /*_ClearCoatMapsClearCoatMaskChannel*/)];
				}
				if ((1.0 /*_ClearCoatMapsRoughnessChannel*/) < 4)
				{
					smoothness *= PBRMaps[(1.0 /*_ClearCoatMapsRoughnessChannel*/)];
				}
				if ((2.0 /*_ClearCoatMapsReflectionMaskChannel*/) < 4)
				{
					reflectionMask *= PBRMaps[(2.0 /*_ClearCoatMapsReflectionMaskChannel*/)];
				}
				if ((3.0 /*_ClearCoatMapsSpecularMaskChannel*/) < 4)
				{
					specularMask *= PBRMaps[(3.0 /*_ClearCoatMapsSpecularMaskChannel*/)];
				}
				#endif
				if ((0.0 /*_ClearCoatGlobalMask*/) > 0)
				{
					clearCoatMask = customBlend(clearCoatMask, poiMods.globalMask[(0.0 /*_ClearCoatGlobalMask*/) - 1], (2.0 /*_ClearCoatGlobalMaskBlendType*/));
				}
				if ((0.0 /*_ClearCoatSmoothnessGlobalMask*/) > 0)
				{
					smoothness = customBlend(smoothness, poiMods.globalMask[(0.0 /*_ClearCoatSmoothnessGlobalMask*/) - 1], (2.0 /*_ClearCoatSmoothnessGlobalMaskBlendType*/));
				}
				if ((16.0 /*_ClearCoatReflectionStrengthGlobalMask*/) > 0)
				{
					reflectionMask = customBlend(reflectionMask, poiMods.globalMask[(16.0 /*_ClearCoatReflectionStrengthGlobalMask*/) - 1], (2.0 /*_ClearCoatReflectionStrengthGlobalMaskBlendType*/));
				}
				if ((16.0 /*_ClearCoatSpecularStrengthGlobalMask*/) > 0)
				{
					specularMask = customBlend(specularMask, poiMods.globalMask[(16.0 /*_ClearCoatSpecularStrengthGlobalMask*/) - 1], (2.0 /*_ClearCoatSpecularStrengthGlobalMaskBlendType*/));
				}
				if ((0.0 /*_ClearCoatMaskInvert*/))
				{
					clearCoatMask = 1 - clearCoatMask;
				}
				if ((0.0 /*_ClearCoatSmoothnessMapInvert*/))
				{
					smoothness = 1 - smoothness;
				}
				if ((0.0 /*_ClearCoatReflectionMaskInvert*/))
				{
					reflectionMask = 1 - reflectionMask;
				}
				if ((0.0 /*_ClearCoatSpecularMaskInvert*/))
				{
				...
				if ((1.0 /*_ClearCoatGSAAEnabled*/))
				{
					percepRough = GSAA_Filament(poiMesh.normals[(0.0 /*_ClearCoatNormalSelect*/)], percepRough, (0.15 /*_ClearCoatGSAAVariance*/), (0.1 /*_ClearCoatGSAAThreshold*/));
				}
				...
				float attenuation = min(poiLight.nDotLSaturated, lerp(poiLight.attenuation, 1, (0.0 /*_CCIgnoreCastedShadows*/)));
				float3 fresnelTerm = 1;
				float3 specularTerm = 1;
				float clearcoatNDotL = lerp(poiLight.vertexNDotL, poiLight.nDotL, (0.0 /*_ClearCoatNormalSelect*/));
				float clearcoatNDotV = lerp(poiLight.vertexNDotV, poiLight.nDotV, (0.0 /*_ClearCoatNormalSelect*/));
				float clearcoatNDotH = lerp(poiLight.vertexNDotH, poiLight.nDotH, (0.0 /*_ClearCoatNormalSelect*/));
				float3 clearcoatReflectionDir = lerp(poiCam.vertexReflectionDir, poiCam.reflectionDir, (0.0 /*_ClearCoatNormalSelect*/));
				...
				specular = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_ClearCoatSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation;
				if (poiFragData.toggleVertexLights)
				{
					#if defined(VERTEXLIGHT_ON)
					for (int index = 0; index < 4; index++)
					{
						fresnelTerm = 1;
						specularTerm = 1;
						float clearcoatVDotNL = lerp(poiLight.vertexVDotNL[index], poiLight.vDotNL[index], (0.0 /*_ClearCoatNormalSelect*/));
						float clearcoatVDotNH = lerp(poiLight.vertexVDotNH[index], poiLight.vDotNH[index], (0.0 /*_ClearCoatNormalSelect*/));
						...
						vSpecular += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_ClearCoatSpecularTintThemeIndex*/)) * poiLight.occlusion;
					}
					#endif
				}
				float surfaceReduction = (1.0 / (brdfRoughness * brdfRoughness + 1.0));
				float grazingTerm = saturate(smoothness + (1 - omr));
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (0.0 /*_ClearCoatForceFallback*/), (1.0 /*_ClearCoatLitFallback*/), _ClearCoatFallback, _ClearCoatFallback_HDR, clearcoatReflectionDir);
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.5 /*_ClearcoatFresnelStrength*/)) * (0.5 /*_ClearcoatFresnelStrength*/), clearcoatNDotV);
				reflections *= poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_ClearCoatReflectionTintThemeIndex*/)) * reflectionMask;
			...
			void ApplyBacklight(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
				backlightColor *= POI2D_SAMPLER_PAN(_BacklightColorTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BacklightColorTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb;
				#endif
				float3 normal = lerp(poiMesh.normals[0], poiMesh.normals[1], (1.0 /*_BacklightNormalStrength*/));
				float3 headDir = normalize(getCameraPosition() - poiMesh.worldPos.xyz);
				float headDotLight = dot(headDir, poiLight.direction);
				float backlightFactor = pow(saturate(-headDotLight * 0.5 + 0.5), max(0, (5.0 /*_BacklightDirectivity*/)));
				float backlightLN = dot(normalize(-headDir * (1.0 /*_BacklightViewStrength*/) + poiLight.direction), normal) * 0.5 + 0.5;
				#if defined(POINT) || defined(SPOT)
				if ((1 /*_BacklightReceiveShadow*/)) backlightLN *= saturate(poiLight.additiveShadow);
				#else
				if ((1 /*_BacklightReceiveShadow*/)) backlightLN *= saturate(poiLight.attenuation);
				#endif
				backlightLN = poiEdgeLinear(backlightLN, (0.35 /*_BacklightBorder*/), (0.05 /*_BacklightBlur*/));
				float backlight = saturate(backlightFactor * backlightLN);
				backlight = !poiMesh.isFrontFace && (1 /*_BacklightBackfaceMask*/) ? 0.0 : backlight;
				backlightColor = lerp(backlightColor, backlightColor * poiFragData.baseColor, (0.0 /*_BacklightMainStrength*/));
			...
			float CalculateAmbientOcclusion(float2 uv, float depth, float3 normal, float radius, float4 worldDirection, PoiMesh poiMesh, PoiCam poiCam)
			{
				...
				int totalSamples = int(((2.4 /*_SSAOQuality*/) * 5) * smoothstep((8.0 /*_SSAOFalloffEnd*/), (6.0 /*_SSAOFalloffStart*/), poiCam.clipPos.w));
				...
				float totalWeight = 0;
				float randomValue = (0.0 /*_SSAORandomScale*/) * (SSAOInterleavedGradientNoise(uv * _ScreenParams.xy) * 2.0 - 1.0);
				[loop]
				for (int sampleIndex = 0; sampleIndex < totalSamples; sampleIndex++)
				{
					...
					float depthDifference = depth - sampleDepth - (0.003 /*_SSAOBias*/);
					float weight = 1;
			...
			{
				if (!DepthTextureExists() || (1.0 /*_SSAOAnimationToggle*/) == 0) return 1;
				...
				{
					mask = maskBlend(mask, poiMods.globalMask[(0.0 /*_SSAOGlobalMaskIndex*/) - 1], (2.0 /*_SSAOGlobalMaskBlendType*/));
				}
				float ssao = CalculateAmbientOcclusion(screenPos, depth, transformedNormal, (0.002 /*_SSAORadius*/), direction, poiMesh, poiCam);
				ssao = lerp(1, ssao, mask);
				if ((0.0 /*_SSAOApplyGlobalMaskIndex*/) > 0)
				{
					applyToGlobalMask(poiMods, (0.0 /*_SSAOApplyGlobalMaskIndex*/) - 1, (0.0 /*_SSAOApplyGlobalMaskBlendType*/), ssao);
				}
				return ssao;
			}
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				if (!DepthTextureExists() || (1.0 /*_SSAOAnimationToggle*/) == 0) return;
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, lilToneCorrection(poiFragData.baseColor, float4(0,0,0,0) + 1), (1 - ssao) * (1.0 /*_SSAOIntensity*/));
				}
				poiFragData.baseColor = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, ssaoColor, (2.0 /*_SSAOBlendType*/)), (1 - ssao) * (1.0 /*_SSAOIntensity*/));
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb * poiLight.vAttenuation[index], (5.0 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb * poiLight.vAttenuation[index];
				...
				if ((0.0 /*_LightingColorMode*/) == 0) // Poi Custom Light Color
				{
					...
					poiLight.indirectColor = BetterSH9(float4(lerp(0, poiMesh.normals[1], (0.5 /*_LightingIndirectUsesNormals*/)), 1));
				}
				...
				{
					poiLight.directColor = min(poiLight.directColor, (2.0 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (2.0 /*_LightingCap*/));
				}
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb * poiLight.attenuation, (5.0 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb * poiLight.attenuation;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.01 /*_LightingAdditivePassthrough*/));
				poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(poiLight.indirectColor, (5.0 /*_LightingAdditiveLimit*/)) : poiLight.indirectColor;
				#endif
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1811642,0.1811642,0.1811642,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1811642,0.1811642,0.1811642,1).a;
				...
				#ifdef _RIM2STYLE_POIYOMI
				#if defined(PROP_RIM2MASK) || !defined(OPTIMIZER_ENABLED)
				float4 rim2MaskAndBias = POI2D_SAMPLER_PAN(_Rim2Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Rim2MaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				float rim2Mask = rim2MaskAndBias[(0.0 /*_Rim2MaskChannel*/)];
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (0.0 /*_Is_NormalMapToRim2Light*/), (0.0 /*_Rim2LightingInvert*/), (1.0 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (0.0 /*_Rim2ShadowToggle*/), (0.4 /*_Rim2Width*/), (1.0 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(1,1,1,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftColorSpace*/), (1.0 /*_Rim2HueSelectOrShift*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.2 /*_Rim2Sharpness*/), (0.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0,0,1), (16.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (0.0 /*_Rim2BaseColorMix*/), (1.0 /*_Rim2Brightness*/), (0.0 /*_RimPoi2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, rim2Bias, (0.0 /*_Rim2BiasIntensity*/), (0 /*_Rim2ApplyAlpha*/), (1.0 /*_Rim2ApplyAlphaBlend*/));
				#endif
				#endif
				#if defined(POI_SSAO)
				...
				if ((1.0 /*_FXProximityColor*/))
				{
					...
					poiFragData.finalColor *= lerp(poiThemeColor(poiMods, float4(0,0,0,1).rgb, (0.0 /*_FXProximityColorMinColorThemeIndex*/)), poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_FXProximityColorMaxColorThemeIndex*/)), smoothstep((-0.05 /*_FXProximityColorMinDistance*/), (0.2 /*_FXProximityColorMaxDistance*/), distance(position, poiCam.worldPos)));

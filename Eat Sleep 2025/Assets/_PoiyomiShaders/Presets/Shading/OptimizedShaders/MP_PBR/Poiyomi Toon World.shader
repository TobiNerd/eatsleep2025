Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/97cc2bfac2a8e7e4692d7c7ad9eeec80"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, (10.0 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (10.0 /*_LightingCap*/));
				}
